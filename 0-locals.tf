locals {
  ...
  amp_remotewrite_irsa = "amp-iamproxy-ingest-service-account"
  ...
  flux_kustomization_name = "grafana-dashboards-infrastructure"
  ...
  flux_kustomization_path = "./artifacts/grafana-operator-manifests/eks/infrastructure"
...
#   adot_service_telemetry_loglevel = "INFO"
